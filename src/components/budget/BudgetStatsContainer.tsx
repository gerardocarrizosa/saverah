  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Income */}
        <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${colorClasses.success} border p-6`}>
          <div className="absolute top-4 right-4 text-3xl">📈</div>
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              <div className={`p-2 rounded-xl bg-base-100/50 ${iconColors.success}`}>
                <TrendingUp className="w-6 h-6" />
              </div>
              <span className="text-sm font-medium text-base-content/70">Ingresos totales</span>
            </div>
        ...
        {/* Expenses */}
        <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${colorClasses.error} border p-6`}>
          <div className="absolute top-4 right-4 text-3xl">📉</div>
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              <div className={`p-2 rounded-xl bg-base-100/50 ${iconColors.error}`}>
                <TrendingDown className="w-6 h-6" />
              </div>
              <span className="text-sm font-medium text-base-content/70">Gastos totales</span>
            </div>
            <p className="text-3xl font-bold text-base-content">
        ...
        {/* Balance */}
        <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${balance >= 0 ? colorClasses.success : colorClasses.error} border p-6`}>
          <div className="absolute top-4 right-4 text-3xl">{balance >= 0 ? '✨' : '⚠️'}</div>
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              <div className={`p-2 rounded-xl bg-base-100/50 ${balance >= 0 ? iconColors.success : iconColors.error}`}>
